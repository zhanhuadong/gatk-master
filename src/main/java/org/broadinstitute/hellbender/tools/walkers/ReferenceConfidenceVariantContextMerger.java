...
public final class ReferenceConfidenceVariantContextMerger {
    ...
    protected final OneShotLogger asWarning = new OneShotLogger(this.getClass());
            ...
            // Otherwise simply treat it as a number
                ...
                try {
                    ...
                    if (key.startsWith("AS")) {
                        asWarning.warn(String.format("Reducible annotation '%s' detected, add -G Standard -G AS_Standard to the command to annotate in the final VC with this annotation.",key));
                    }
                }
            }
        }
