...
//        private AnnotationManager(final List<String> annotationsToUse, final List<String> annotationsToExclude){
...
//
//            final Set<String> unknownGroups =  Sets.difference( new LinkedHashSet<>(AnnotationManager.getAllAnnotationGroupNames()));
