...
import org.broadinstitute.hellbender.tools.copynumber.multidimensional.model.MultidimensionalModeller;
...
public final class AlleleFractionModeller {
     ...
     */
    public AlleleFractionModeller(final AllelicCountCollection allelicCounts,
    ...
    AlleleFractionModeller(final AlleleFractionSegmentedData data,
                           final AlleleFractionPrior prior) {
        this(data.getAllelicCounts(), data.getSegments(), prior);
    }
