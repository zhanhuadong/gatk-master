...
public class IntegerCopyNumberStateCollection {
    ...
    protected IntegerCopyNumberStateCollection(final List<String> copyNumberStatesColumns) {
    ...
    protected IntegerCopyNumberState parseIntegerCopyNumber(final String copyNumberStateString) {
