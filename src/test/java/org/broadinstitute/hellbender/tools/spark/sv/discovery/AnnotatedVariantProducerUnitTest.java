...
public class AnnotatedVariantProducerUnitTest extends GATKBaseTest {
    ...
    public void testEvidenceAnnotation(final Tuple4<AlignmentInterval, AlignmentInterval, NovelAdjacencyReferenceLocations, String> testData,
        ...
        final String sourceContigName = testData._4();
        final List<ChimericAlignment> chimericAlignments = Collections.singletonList(new ChimericAlignment(region1, region2,
                Collections.emptyList(), sourceContigName, seqDict));
    ...
    public void testIntegrative(final Tuple4<AlignmentInterval, AlignmentInterval, NovelAdjacencyReferenceLocations, String> testData,
        ...
        final VariantContext variantContext =
                AnnotatedVariantProducer
                        .produceAnnotatedVcFromInferredTypeAndRefLocations(breakpoints.leftJustifiedLeftRefLoc,
                        breakpoints.leftJustifiedRightRefLoc.getStart(), breakpoints.complication,
                                InsDelVariantDetector.inferTypeFromNovelAdjacency(breakpoints),
    ...
    private Object[][] dataForIntegrativeTest() {
        ...
        final Broadcast<ReferenceMultiSource> referenceBroadcast = testSparkContext.broadcast(reference);
        final Broadcast<SAMSequenceDictionary> refSeqDictBroadcast = testSparkContext.broadcast(seqDict);
    ...
    public void testProcessEvidenceTargetLinks(final List<EvidenceTargetLink> etls,
        ...
        final List<VariantContext> processedVariantContexts =
                AnnotatedVariantProducer.annotateBreakpointBasedCallsWithImpreciseEvidenceLinks(inputVariants,
                        evidenceTree, metadata, reference, params, localLogger);
